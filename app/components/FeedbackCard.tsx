		...
		<div className="rounded-lg border border-slate-200 bg-white p-6 shadow-sm">
			{hasFeedback ? (
				<div className="space-y-3">
					<p className="text-sm text-[#43302E]">Reviewer Feedback</p>
					<p className="text-2xl font-bold text-[#43302E]">Score: {score}/5</p>
					<p className="rounded-md bg-slate-100 p-3 text-sm text-[#43302E]">
						{comment}
					</p>
				</div>
			) : (
